-- Cria banco de dados clinica e já coloca em uso
...
GO
--- Cria tabela Especialidade do médico
...
-- Adiciona coluna dia_atendimento para o médico
ALTER TABLE medico
...
GO
SELECT * FROM medico --Verifica alteração
GO
-------------------------------------------
--Atualizar endereco do médico Lucas Borges para: 
...
--Mudar o tipo de dado da coluna observação, da tabela consulta
--- para VARCHAR(200)
